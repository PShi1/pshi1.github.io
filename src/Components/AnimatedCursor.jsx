...
export function AnimatedCursor({
  ...
  React.useEffect(() => {
    const clickables = document.querySelectorAll(
      'a, input[type="submit"], input[type="image"], label[for], select, button, .link, .cards-div, .tag-container, .scroll-down, .footer-icon, .collapsible-header, .hover-cursor, .group, .subgroup'
    )
